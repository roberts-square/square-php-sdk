...
class MerchantsApi extends BaseApi
{
     ...
     *
     * @param Models\SetupMerchantRequest $body An object containing the fields to POST for the
     *        request.
     *
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function setupMerchant(Models\SetupMerchantRequest $body): ApiResponse
    {
        //prepare query string for API call
        $_queryUrl = $this->config->getBaseUri() . '/v2/merchants/setup';
