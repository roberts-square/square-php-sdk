...
class InventoryApi extends BaseApi
{
     ...
     *
     * @param Models\UpdateInventoryAdjustmentRequest $body An object containing the fields to POST
     *        for the request.
     *
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function updateInventoryAdjustment(Models\UpdateInventoryAdjustmentRequest $body): ApiResponse
    {
        //prepare query string for API call
        $_queryUrl = $this->config->getBaseUri() . '/v2/inventory/adjustments/update';
