...
/**
 * Represents a response from a get request containing the requested `CustomAttributeDefinition` object
 * or error messages.
 */
class GetCaPlayResourceCustomAttributeDefinitionApiResponse implements \JsonSerializable
{
    /**
