...
/**
 * Represents a response from a update request containing the updated `CustomAttributeDefinition`
 * object or error messages.
 */
class UpdateCaPlayResourceCustomAttributeDefinitionApiResponse implements \JsonSerializable
{
    /**
