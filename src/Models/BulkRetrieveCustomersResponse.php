...
class BulkRetrieveCustomersResponse implements \JsonSerializable
{
    ...
    /**
     * Returns Responses.
     * A map of key-value pairs as the [RetrieveCustomer](#endpoint-retrievecustomer) response body.
     *
     * Each key-value pair in the map represents an `{customer.id: RetrieveCustomerResponse}`
     * combination. If the `RetrieveCustomer` request fails, the entry includes error information about
     * the failure.
     *
