...
/**
 * Represents a response from a create request containing the created `CustomAttributeDefinition`
 * object or error messages.
 */
class CreateCaPlayResourceCustomAttributeDefinitionApiResponse implements \JsonSerializable
{
    /**
