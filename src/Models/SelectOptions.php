...
class SelectOptions implements \JsonSerializable
{
    ...
    /**
     * Returns Body.
     * The body text to display under the title in the select screen flow on the Terminal.
     */
    ...
    /**
     * Returns Options.
     * Represents the buttons/options that should be displayed in the select screen.
     *
     * @return SelectOption[]
     */
