 ...
 * a request to the
 * [UpdateWebhookSubscriptionFilter]($e/WebhookSubscriptionFilters/UpdateWebhookSubscriptionFilter)
 * endpoint.
 *
 * Note: if there are errors processing the request, the subscription filter field will not be
 * present.
 */
class UpdateWebhookSubscriptionFilterResponse implements \JsonSerializable
{
    /**
     * @var Error[]|null
     */
