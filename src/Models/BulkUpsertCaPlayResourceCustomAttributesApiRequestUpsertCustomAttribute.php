...
/**
 * Represents a upsert request for a `CustomAttribute` object in a
 * BulkUpsertCaPlayResourceCustomAttributes request
 */
class BulkUpsertCaPlayResourceCustomAttributesApiRequestUpsertCustomAttribute implements \JsonSerializable
{
    /**
     * @var CustomAttribute
     */
