...
class ConfirmationOptions implements \JsonSerializable
{
    ...
    /**
     * Returns Body.
     * The agreement details to display in the confirmation screen flow on the Terminal.
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->disagreeButtonText)) {
            $json['disagree_button_text'] = $this->disagreeButtonText;
        }
