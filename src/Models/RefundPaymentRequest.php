...
class RefundPaymentRequest implements \JsonSerializable
{
     ...
     * a card-on-file or bank-on-file identifier; a bank nonce; a cash/external payment.
     * Required for requests specifying unlinked=true.
     * Otherwise, if included when unlinked=false, will throw error.
     */
     ...
     * If set to true, destination_id must be supplied.
     */
