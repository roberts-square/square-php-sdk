...
/**
 * Represents a response from an upsert request containing the updated `CustomAttribute` object or
 * error messages.
 */
class UpsertCaPlayResourceCustomAttributeApiResponse implements \JsonSerializable
{
    /**
