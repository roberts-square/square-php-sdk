...
class TenderType
{
    ...
    /**
     * A non-Square gift card.
     */
    public const MERCHANT_GIFT_CARD = 'MERCHANT_GIFT_CARD';

    /**
     * An electronic money card not processed by Square.
     */
    public const THIRD_PARTY_E_MONEY = 'THIRD_PARTY_E_MONEY';
