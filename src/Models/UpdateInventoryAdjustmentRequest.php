...
class UpdateInventoryAdjustmentRequest implements \JsonSerializable
{
    /**
     * @var string
     */
    ...
    /**
     * @var InventoryAdjustmentUpdate|null
     */
    private $update;
     ...
     */
    public function getUpdate(): ?InventoryAdjustmentUpdate
    {
        return $this->update;
    }
     ...
     * @maps update
     */
    public function setUpdate(?InventoryAdjustmentUpdate $update): void
    {
        $this->update = $update;
    }
