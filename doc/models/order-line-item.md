...
| `quantityEntryType` | [`?string (OrderLineItemQuantityEntryType)`](../../doc/models/order-line-item-quantity-entry-type.md) | Optional | How the quantity was added to the line item. | getQuantityEntryType(): ?string | setQuantityEntryType(?string quantityEntryType): void |
| `taxCategory` | [`?string (TaxCategory)`](../../doc/models/tax-category.md) | Optional | Represents the line item tax category. | getTaxCategory(): ?string | setTaxCategory(?string taxCategory): void |
| `returnedQuantities` | [`?(OrderReturnedQuantity[])`](../../doc/models/order-returned-quantity.md) | Optional | List of ReturnedQuantity to indicate what has been returned for itemized returns for<br>this line item | getReturnedQuantities(): ?array | setReturnedQuantities(?array returnedQuantities): void |
...
| `appliedTaxExemptions` | [`?(OrderAppliedTaxExemption[])`](../../doc/models/order-applied-tax-exemption.md) | Optional | The list of references to tax exemption applied to this line<br>item. Each `OrderLineItemAppliedTaxExemption` has a<br>`tax_exemption_uid` that references the `uid` of a top-level<br>`OrderLineItemTaxExemption` applied to the line item.<br>`OrderLineItemAppliedTaxExemption` records for `LINE_ITEM`<br>scoped tax exemptions must be added in requests for the tax exemption<br>to apply to any line items. | getAppliedTaxExemptions(): ?array | setAppliedTaxExemptions(?array appliedTaxExemptions): void |
