...
| `sku` | `?string` | Optional | The SKU of the item variation. | getSku(): ?string | setSku(?string sku): void |
...
| `restockType` | [`?string (OrderReturnLineItemRestockType)`](../../doc/models/order-return-line-item-restock-type.md) | Optional | - | getRestockType(): ?string | setRestockType(?string restockType): void |
