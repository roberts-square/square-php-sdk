...
| `accountId` | `?string` | Optional | The ID of the account that took the payment that this refund is associated with. | getAccountId(): ?string | setAccountId(?string accountId): void |
...
| `appProcessingFee` | [`?(AppProcessingFee[])`](../../doc/models/app-processing-fee.md) | Optional | Processing fees returned by the third-party application platform for this refund. | getAppProcessingFee(): ?array | setAppProcessingFee(?array appProcessingFee): void |
