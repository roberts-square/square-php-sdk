...
| `DINING_OPTION` | The `CatalogObject` instance is of the [CatalogDiningOption](../../doc/models/catalog-dining-option.md) type and represents a dining option. The dining-option-specific data<br>will be stored in the `dining_option_data` field. |
| `TAX_EXEMPTION` | The `CatalogObject` instance is of the [CatalogTaxExemption](../../doc/models/catalog-tax-exemption.md) type and represents a tax exemption rule. The rule-specific data<br>must be set on the `tax_exemption_data` field. |
| `SERVICE_CHARGE` | The `CatalogObject` instance is of the [CatalogServiceCharge](../../doc/models/catalog-service-charge.md) type and represents a service charge. The service-charge-specific data<br>will be stored in the `service_charge_data` field. |
