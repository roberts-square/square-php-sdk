...
# Update Ca Play Resource Custom Attribute Definition Api Request

Represents an update request for a `CustomAttributeDefinition` object.

## Structure

`UpdateCaPlayResourceCustomAttributeDefinitionApiRequest`
