...
| `paymentId` | `?string` | Optional | deprecated in favor of payment_id inside type_*_details field https://plathome.sqprod.co/docs/build/proto-options | getPaymentId(): ?string | setPaymentId(?string paymentId): void |
