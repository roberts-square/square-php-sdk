...
# Update Ca Play Resource Custom Attribute Definition Api Response

Represents a response from a update request containing the updated `CustomAttributeDefinition` object or error messages.
