...
| `calculateTipBeforeTaxes` | `?bool` | Optional | Indicates whether the tip should be calculated based on the pre-tax payment amount, as opposed<br>to the post-tax payment amount.<br>Defaults to true. | getCalculateTipBeforeTaxes(): ?bool | setCalculateTipBeforeTaxes(?bool calculateTipBeforeTaxes): void |
...
```json
{
  ...
  "smart_tipping": null,
  "calculate_tip_before_taxes": null
}
```
