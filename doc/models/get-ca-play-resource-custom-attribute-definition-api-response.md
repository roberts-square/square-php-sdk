...
# Get Ca Play Resource Custom Attribute Definition Api Response

Represents a response from a get request containing the requested `CustomAttributeDefinition` object or error messages.
