...
| `digitalDetails` | [`?OrderFulfillmentDigitalDetails`](../../doc/models/order-fulfillment-digital-details.md) | Optional | - | getDigitalDetails(): ?OrderFulfillmentDigitalDetails | setDigitalDetails(?OrderFulfillmentDigitalDetails digitalDetails): void |
...
| `simpleDetails` | [`?OrderFulfillmentSimpleDetails`](../../doc/models/order-fulfillment-simple-details.md) | Optional | - | getSimpleDetails(): ?OrderFulfillmentSimpleDetails | setSimpleDetails(?OrderFulfillmentSimpleDetails simpleDetails): void |
| `locationId` | `?string` | Optional | The location that performs the fulfillment and from which inventory is drawn. | getLocationId(): ?string | setLocationId(?string locationId): void |
| `createdAt` | `?string` | Optional | The timestamp for when the fulfillment was created, in RFC 3339 format<br>(for example, "2016-09-04T23:59:33.123Z"). | getCreatedAt(): ?string | setCreatedAt(?string createdAt): void |
