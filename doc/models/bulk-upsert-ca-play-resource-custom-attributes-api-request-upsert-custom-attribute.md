...
# Bulk Upsert Ca Play Resource Custom Attributes Api Request Upsert Custom Attribute

Represents a upsert request for a `CustomAttribute` object in a BulkUpsertCaPlayResourceCustomAttributes request

## Structure

`BulkUpsertCaPlayResourceCustomAttributesApiRequestUpsertCustomAttribute`
