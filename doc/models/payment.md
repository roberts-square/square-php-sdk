...
| `appProcessingFee` | [`?(AppProcessingFee[])`](../../doc/models/app-processing-fee.md) | Optional | The application-defined processing fees for this payment. | getAppProcessingFee(): ?array | setAppProcessingFee(?array appProcessingFee): void |
